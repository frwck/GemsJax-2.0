...
public class FileServlet extends HttpServlet {
    ...
    private static final long DEFAULT_EXPIRE_TIME = 1; // ..ms = 1 week.
    ...
    public FileServlet(String warDirPath)
    {
    	this.basePath = warDirPath;
    }
    
    public FileServlet(String warDirPath, String startFileUrl)
    {
    	this.basePath = warDirPath;
...
//    	System.out.println("File session: "+request.getSession(true).getId() + " path "+request.getPathInfo());
    ...
    public void setStartSite(String startSiteUrl)
    {
    	this.startFileUrl = startSiteUrl;
    }
