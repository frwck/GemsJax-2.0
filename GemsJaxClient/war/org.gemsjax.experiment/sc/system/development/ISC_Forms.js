...
,isc.A.setThumb=function isc_RecordScrollbar_setThumb(){if(!this.$71j)return;if(this.isDrawn()&&this.thumb.isDrawn())this.thumb.moveAbove(this);var _1=this.trackSize();if(this.data!=null&&this.data.getLength()>0){_1=_1/ this.data.getLength();_1=Math.max(this.thumbMinSize,Math.round(_1))}
...
);isc.B._maxIndex=isc.C+13;isc.ClassFactory.defineClass("MultiRecordForm","HLayout");isc.A=isc.MultiRecordForm.getPrototype();isc.A.initialRecord=0;isc.A=isc.MultiRecordForm.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function isc_MultiRecordForm_initWidget(){this._form=this.$71k();this.$71l=this.$71m();this.addMembers([this._form,this.$71l]);this.observe(this.$71l,"positionChanged","observer.updateForm()");this.showRecord(this.initialRecord);this.updateForm()}
,isc.A.updateForm=function isc_MultiRecordForm_updateForm(){if(this.data==null)return;var _1=this.$71l.getCurrentPosition();this._form.setData(this.data.get(_1))}
...
this.data=_1;this.observe(this.data,"dataChanged","observer.updateForm()");this.$71l.setData(_1);this.showRecord(this.initialRecord);this.updateForm()}
,isc.A.showRecord=function isc_MultiRecordForm_showRecord(_1){if(isc.isA.Number(_1)){this.$71l.setPosition(_1)}else{this.$71l.setPosition(this.data.indexOf(_1))}}
,isc.A.$71k=function isc_MultiRecordForm__createForm(){return isc.DynamicForm.create({ID:this.getID()+"_form",autoDraw:false,overflow:"auto",height:"100%",dataSource:this.dataSource},this.formProperties)}
,isc.A.$71m=function isc_MultiRecordForm__createScrollBar(){return isc.RecordScrollbar.create({ID:this.getID()+"$71n",autoDraw:false,width:16,height:"100%",data:this.data,position:this.initialRecord})}
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("MultiView","VLayout");isc.A=isc.MultiView.getPrototype();isc.A.$71o={};isc.A.views=["ListGrid","TileGrid"];isc.A.ListGridDefaults={_constructor:"ListGrid",name:"ListGrid"};isc.A.TileGridDefaults={_constructor:"TileGrid",name:"TileGrid"};isc.A.CalendarDefaults={_constructor:"Calendar",name:"Calendar"};isc.A.DetailViewerDefaults={_constructor:"DetailViewer",name:"DetailViewer"};isc.A.TreeGridDefaults={_constructor:"TreeGrid",name:"TreeGrid"};isc.A.currentView="ListGrid";isc.A.showFilterEditor=true;isc.A.autoFetchData=true;isc.A.dbcDefaults={showPanelHeader:true,tileWidth:100,tileHeight:150};isc.A.dbcProperties={};isc.A=isc.MultiView.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function isc_MultiView_initWidget(){this.Super(this.$sb);this.dataSource=isc.DataSource.getDataSource(this.dataSource);this.setShowFilter(this.showFilter);this.setCurrentView(this.currentView,true)}
,isc.A.setDataSource=function isc_MultiView_setDataSource(_1,_2){this.dataSource=isc.DS.getDataSource(_1);for(var _3 in this.$71o){var _4=this.$71o[_3];_4.setDataSource(this.dataSource,_2);_4.title=_4.dataSource?_4.dataSource.ID:""}
...
,isc.A.bindToDataSource=function isc_MultiView_bindToDataSource(_1,_2){for(var _3 in this.$71o){this.$71o[_3].bindToDataSource(_1,_2)}}
...
,isc.A.createFilter=function isc_MultiView_createFilter(){this.filterForm=isc.AdvancedFilter.create({ID:this.getID()+"$3y",autoDraw:false,dataSource:this.dataSource,dualMode:true,currentMode:"simple",mv:this,filter:function(_1,_2){this.Super("filter",[this.mv.currentDBC,_2])}},this.filterProperties)}
,isc.A.setCurrentView=function isc_MultiView_setCurrentView(_1,_2){if(_1==null)_1=this.currentView;this.currentView=_1;if(this.currentDBC)this.currentDBC.hide();if(_2){var _3=this.$71o[_1]=this.createAutoChild(_1,this.$71p(_1));this.addSwitcher(_3)}else{this.$71q(_1)}
this.currentDBC=this.$71o[_1];this.addMember(this.currentDBC);this.currentDBC.show();this.showView(this.currentDBC)}
,isc.A.$71p=function isc_MultiView__getCombinedDBCProperties(_1){var _2=isc.addProperties({},this.dbcDefaults,this.dbcProperties,{dataSource:this.dataSource,title:this.title,icon:this.icon,multiView:this,showFilterEditor:this.showFilterEditor,autoFetchData:this.autoFetchData,recordClick:this.$71r});return _2}
,isc.A.$71q=function isc_MultiView__initView(_1){var _2=this.getView(_1);if(!_2){var _2=this.$71o[_1]=this.createAutoChild(_1,this.$71p(_1));this.addSwitcher(_2)}
...
,isc.A.getView=function isc_MultiView_getView(_1){return this.$71o[_1]}
...
,isc.A.$71r=function isc_MultiView__dbcRecordClick(){var _1;if(isc.isA.ListGrid(this))_1=arguments[1];else if(isc.isA.TileGrid(this))_1=arguments[2];return this.multiView.recordClick(_1,this)}
...
,isc.A.setViewType=function isc_DOMView_setViewType(_1){_1=_1||this.pickForm.getValue("viewType");this.viewType=_1;this.pickForm.setValue("viewType",_1);this.setXMLText(this.textView.getValue("xmlText"));if(this.viewType=="none"){this.treeView.hide();this.textView.hide();var _2=21;this.setHeight(_2);this.$tt=_2;return}
this.$tt=null;if(_1=="tree"){this.textView.hide();if(this.xmlDocument){this.treeView.setRootElement(this.xmlDocument.documentElement)}
this.treeView.show()}else{this.treeView.hide();this.textView.show()}}
,isc.A.fetchXML=function isc_DOMView_fetchXML(){isc.xml.loadXML(this.getURL(),this.getID()+".$71s(xmlText)")}
,isc.A.$71s=function isc_DOMView__fetchXMLReply(_1){this.setXMLText(_1)}
...
var _5=this.urlForm.getValues();var _6=isc.DataSource.create(_5);var _7=_6.getServiceInputs({data:_2});_7.callback=this.getID()+".$71u(xmlDoc);";isc.xml.sendXMLRequest(_7)}
,isc.A.$71u=function isc_XMLBinder__sendReply(_1){this.rawResults=_1;this.displayArea.setRootElement(_1.documentElement)}
...
,isc.A.editElement=function isc_DOMEditor_editElement(_1){this.$18q=_1;var _2=isc.addProperties({},_1);var _3=_1.innerHTML;_2.innerHTML=_3.replace(/ $71v(Reported|Calculated)Offset(Left|Top)="\d{1,4}"/g,"");if(_1.style!=null){var _4=this.getItems();for(var i=0;i<_4.length;i++){var _6=_4[i],_7=_6.getFieldName();if(_7.startsWith("style.")){_2[_7]=this.getElementValue(_7)}}}
...
,isc.A.isTableElement=function isc_DOMEditor_isTableElement(){if(this.$18q==null)return false;var _1=this.$18q,_2=_1.tagName;return _2!=null&&_2.toLowerCase()=="table"}
,isc.A.getElementValue=function(fieldName){var element=this.$18q;if(element==null)return null;if(fieldName.startsWith("style.")){element=element.style;if(element==null)return null;fieldName=fieldName.substring(6)}
var oldValue;try{isc.eval("oldValue = "+this.getID()+".$18q."+fieldName+";")}catch(e){oldValue="Error: "+e.description}
return oldValue}
,isc.A.setElementValue=function(fieldName,newValue){var element=this.$18q;if(element==null)return;isc.eval("element."+fieldName+"=newValue")}
,isc.A.itemChange=function isc_DOMEditor_itemChange(_1,_2,_3){if(_1==null)return;this.saveToElement(_1.getFieldName(),_2)}
,isc.A.saveToElement=function isc_DOMEditor_saveToElement(_1,_2){var _3=this.$18q;if(_3==null)return;var _4=this.getElementValue(_1);if(_4!=_2){this.logWarn("changed "+_1+" from "+this.echoLeaf(_4)+" to "+this.echoLeaf(_2));if(_1=="innerHTML"&&isc.Browser.isIE){return this.$71w(_3,_4,_2)}
...
,isc.A.$71w=function isc_DOMEditor__replaceIEInnerHTML(_1,_2,_3){var _4=_1;while(_4!=null){var _5=_4.tagName;if(_5==null)continue;_5=_5.toLowerCase();if(_5=="div"||_5=="td")break;_4=_4.parentNode}
if(_4==null){this.logWarn("Couldn't change innerHTML, no safe parent found");return}
var _6=_4.innerHTML;_6=_6.replace(_2,_3);_4.innerHTML=_6;this.logWarn("replaced innerHTML on ancestor: "+this.echoLeaf(_4));var _7=this.inspector,_8=_7.treeGrid.data,_9=_8.find("$18q",_4);_8.reloadChildren(_9);_8.loadSubtree(_9);this.editElement(_4)}
...
,isc.A.removeSelectedElement=function isc_DOMInspector_removeSelectedElement(){var _1=this.treeGrid.getSelectedRecord();if(_1==null)return;var _2=this.treeGrid.data;var _3=_2.getParent(_1);var _4=_1.$18q;if(_4&&_4.parentNode)_4.parentNode.removeChild(_4);this.domEditor.clearValues();_2.reloadChildren(_3)}
