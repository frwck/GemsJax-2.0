...
,isc.A.downloadFile=function isc_DataSource_downloadFile(_1,_2,_3){this.$74u("downloadFile",_1,_2,_3)}
,isc.A.viewFile=function isc_DataSource_viewFile(_1,_2,_3){this.$74u("viewFile",_1,_2,_3)}
,isc.A.getFileURL=function isc_DataSource_getFileURL(_1,_2,_3){return this.streamFile(_1,_2,_3)}
,isc.A.streamFile=function isc_DataSource_streamFile(_1,_2,_3){_3=isc.addProperties({$74v:true,downloadResult:true},_3);return this.$74u("viewFile",_1,_2,_3)}
,isc.A.$74u=function isc_DataSource__streamFile(_1,_2,_3,_4){if(!_4)_4={};if(!_3){var _5=this.getFields();for(var _6 in _5){if(_5[_6].type=="binary"||_5[_6].type=="imageFile"){_3=_6;break}}}
...
);isc.B._maxIndex=isc.C+172;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$65f=0;isc.A.$65g={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
);isc.B._maxIndex=isc.C+1;isc.A=isc.RPCManager;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.allowCrossDomainCalls=false;isc.A.$66b=0;isc.A.onLine=!isc.isOffline();isc.A.$66c="text/xml";isc.A.loginStatusCodeMarker="<SCRIPT>//'\"]]>>isc_";isc.A.loginRequiredMarker="<SCRIPT>//'\"]]>>isc_loginRequired";isc.A.loginSuccessMarker="<SCRIPT>//'\"]]>>isc_loginSuccess";isc.A.maxLoginAttemptsExceededMarker="<SCRIPT>//'\"]]>>isc_maxLoginAttemptsExceeded";isc.A.$74w="//isc_RPCResponseStart-->";isc.A.$74x="//isc_RPCResponseEnd";isc.A.$74y="//isc_JSONResponseStart-->";isc.A.$74z="//isc_JSONResponseEnd";isc.A.$740="<responses>";isc.A.$741="</responses>";isc.A.$742="<response>";isc.A.$743="</response>";isc.B.push(isc.A.xmlHttpRequestAvailable=function isc_c_RPCManager_xmlHttpRequestAvailable(){if(isc.Browser.isIE)return(isc.Comm.createXMLHttpRequest()!=null);return true}
...
this.clearTransactionTimeout(_2);isc.Comm.closeOperationPromptWindow(_2);if(!this.$66l&&isc.Page.isLoaded()){var _3=isc.LogViewer.getGlobalLogCookie();this.setTrackRPC(_3?_3.trackRPC:false)}
...
,isc.A.$66p=function isc_c_RPCManager__timeoutTransaction(_1){_1=this.getTransaction(_1);if(_1.$66h){isc.Comm.closeOperationPromptWindow(_1);this.clearTransaction(_1);return}
...
_4.sendTime=isc.timeStamp();_4.changed();_4.callback="isc.RPCManager.performTransactionReply(transactionNum,results,wd)";if(_1)_4.$66u=_1;if(_5.directSubmit){isc.Comm.generateJSCallback(_4);var _14=_5.submitForm;var _15=_14.getForm();if(_14.getItem("_transaction")!=null&&isc.isA.HiddenItem(_14.getItem("_transaction")))
{_14.setValue("_transaction",this.serializeTransaction(_4));this.logInfo("Direct submit assigning request data to hidden field instead of"+" submitting as GET request");_14.setAction(this.addParamsToURL(_3,_8),true)}else{if(_5.useSimpleHttp){_14.setAction(this.addParamsToURL(_3,_8),true);_4.$66h=true}else{_14.setAction(this.transactionAsGetRequest(_4,null,_8),true)}}
this.$66o(_4);if(_5.target){if(_5.target!=window)_15.target=_5.target;_14.submitForm()}else{var _16=isc.Comm.getTargetableFrame(_5.prompt);_15.target=_16.getName();_4.$cv=_16;_16.draw(_14.getID()+".submitForm()")}}else if(_5.downloadResult){if(!window.name)window.name=isc.timeStamp();var _17=_4.download_filename;if(_5.downloadToNewWindow==false||(_5.downloadToNewWindow==null&&_5.exportFilename)){var _17=window.name}
if(_5.$74v){this.clearTransaction(_4);_4.transactionRequest=this.transactionAsGetRequest(_4,_3,_8);return _4.transactionRequest}
var _11=isc.addProperties(_8,{_transaction:this.serializeTransaction(_4),protocolVersion:"1.0"});_4.$66h=true;this.$66o(_4);_4.$cv=isc.Comm.sendHiddenFrame({URL:_3,httpMethod:_5.httpMethod,httpHeaders:_5.httpHeaders,contentType:_5.contentType,fields:_11,target:_17,transactionNum:_4.transactionNum,transaction:_4})}else{var _11=_8;var _18=_4.transport,_19="send"+(_18.substring(0,1).toUpperCase())+_18.substring(1);if(isc.Comm[_19]==null){this.logWarn("Attempt to send transaction with specified transport '"+_4.transport+"' failed - unsupported transaction type.");return}
this.$66o(_4);var _20;if(_5.isRestRequest){if(_4.operations.length>1){if(_5.contentType==this.$66c){_20="<transaction transactionNum=\""+_4.transactionNum+"\">";_20+="<operations>"
...
isc.RPCManager.$l9.push(_4.transactionNum);_4.transactionRequest=isc.Comm[_19]({URL:_3,httpMethod:_5.httpMethod,contentType:_5.contentType,httpHeaders:_5.httpHeaders,bypassCache:_5.bypassCache,data:_20,fields:_11,target:_5.target,callbackParam:_5.callbackParam,transport:_4.transport,blocking:_5.blocking,useSimpleHttp:_5.useSimpleHttp,transactionNum:_4.transactionNum,transaction:_4})}
...
delete _4.$66n;delete _4.abortCallbacks;_4.receiveTime=isc.timeStamp();_4.changed();isc.RPCManager.$l9.remove(_1);this.logInfo("transaction "+_1+" arrived after "+(_4.receiveTime-_4.sendTime)+"ms");if(_3)_4.$cv=_3;if(_2==null){this.logFatal("No results for transaction "+_1);isc.Comm.closeOperationPromptWindow(_4);return false}
...
return _5}
,isc.A.$744=function isc_c_RPCManager__stripStructuredTags(_1){var _2=_1.indexOf(this.$74w);if(_2!=-1){return _1.substring(_2+this.$74w.length,_1.lastIndexOf(this.$74x))}
return _1}
,isc.A.$745=function isc_c_RPCManager__stripRestTags(_1){var _2=_1.indexOf(this.$74y);if(_2!=-1){return _1.substring(_2+this.$74y.length,_1.lastIndexOf(this.$74z))}
return _1}
,isc.A.$746=function isc_c_RPCManager__stripXMLTransactionTags(_1){var _2=_1.indexOf(this.$740);if(_2!=-1){return _1.substring(_2+this.$740.length,_1.lastIndexOf(this.$741))}
return _1}
,isc.A.$66v=function isc_c_RPCManager__getXMLResponses(_1){_1=this.$746(_1);var _2=[];var _3=0;if(_1){while(true){var _4=_1.indexOf(this.$742,_3);if(_4==-1)break;_3=_1.indexOf(this.$743,_4);if(_3==-1)break;_2.add(_1.substring(_4,_3+this.$743.length))}}
return _2}
...
var _3;if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else if(_2.allClientOnly){_2.results={status:0};_2.receiveTime=isc.timeStamp()}else{var _4=_2.results?_2.results.indexOf(this.$74w):-1;_3=_4!=-1;if(_3){var _5=_2.results;_5=this.$744(_5);try{_2.results=isc.eval(_5)}catch(e){this.logWarn("Error evaling structured RPC response: "+e+" response text: "+_5)}}else{var _6=_2.results?_2.results.indexOf(this.$74y):-1;_3=_6!=-1;if(_3){var _7=_2.results;_7=this.$745(_7);try{_2.results=isc.eval("("+_7+")")}catch(e){this.logWarn("Error evaling REST RPC response: "+e+" response text: "+_7)}}}
...
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$66u){var _18=_14.application?_14.application:this.getDefaultApplication();if(isc.isA.String(_18))_18=window[_18];_18.fireCallback(_2.$66u,"responses",[_2.responses])}}
...
);isc.B._maxIndex=isc.C+1;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$747={};isc.B.push(isc.A.loadSchema=function isc_c_DataSource_loadSchema(_1,_2,_3){var _4=isc.DataSource.$747;if(_4[_1]){_4[_1].add(_2);return null}
_4[_1]=[];_4[_1].add(_2);var _5=_1+"_loadSchema";_3=_3||{};if(!_3.prompt)_3.prompt="loading datasource '"+_1+"'";_3.dsName=_1;this.logInfo("performing operation: "+_5);isc.rpc.performOperation(_5,{},"isc.DS.$748(rpcResponse,data,rpcRequest)",_3)}
,isc.A.$748=function isc_c_DataSource__getDataSourceReply(_1,_2,_3){var _4=_2==null||_2.length==0,_5=!_4?_2[0].dsName:_3.dsName;if(_1.status!=0||_4){isc.DataSource.logError("dynamic datasource fetch failed for datasource '"+_5+"'. "+(isc.isA.String(_2)?_2:""));return}
...
var _7=isc.DS.get(_5);var _8=isc.DataSource.$747;for(var i=0;i<_8[_5].length;i++){isc.DataSource.logInfo("calling registered callback: "+(_8[_5])[i]);this.fireCallback(_8[_5][i],"ds",[_7],_7)}
delete _8[_5]}
...
_3._dsRequest=_1;this.logInfo("performDSOperation("+_5+") "+(isc.isAn.Array(_2)?_2.length:1)+" records"+(isc.rpc.queuing?", queuing":""));_3.callback={target:this,methodName:"$749"};if(isc.DataSource.addMetaDataToQueryString){if(!_3.queryParams)_3.queryParams={};isc.addProperties(_3.queryParams,{ds_name:_1.dataSource,ds_op:_1.operationType});if(_1.startRow!=null){isc.addProperties(_3.queryParams,{ds_startRow:_1.startRow,ds_endRow:_1.endRow})}
...
_1._dsRequest=_1;this.delayCall("$749",[_3,_3.data,_1],0);return true;}else if(_2.useOfflineCache||_2.useOfflineCacheOnly){var _3=isc.Offline.getResponse(_2);if(_3!=null){if(this.useOfflineResponse&&!this.useOfflineResponse(_2,_3))
{this.logInfo("User-written useOfflineResponse() method returned"+" false; not using cached response","offline");_3=null}}
if(_3!=null){_1._dsRequest=_1;this.delayCall("$749",[_3,_3.data,_1],0);return true}else if(_1.useOfflineCacheOnly){_3={status:isc.RPCResponse.STATUS_OFFLINE,data:[]}
_1._dsRequest=_1;this.delayCall("$749",[_3,_3.data,_1],0);return true}}}}
return false}
,isc.A.$749=function isc_DataSource__handleSCServerReply(_1,_2,_3){var _4=_3._dsRequest;this.$64g(_2,_1,_4,_1,_3)}
,isc.A.prepareDataSourceData=function isc_DataSource_prepareDataSourceData(_1,_2,_3){var _4=isc.DS.$635(_1);switch(_4){case"fetch":case"remove":case"downloadFile":case"viewFile":_2={criteria:_2};break;case"add":case"replace":case"validate":_2={values:_2};break;case"update":var _5=_2;var _6=(_3&&_3.values)?_3.values:_2;var _7=this.filterPrimaryKeyFields(_5);if(!_7)return null;if(!_6)return null;_2={criteria:_7,values:_6};break;default:_2={values:_2};break}
return _2}
...
if(!_4)_4=_5.getName();var _12="",_13="AUTO_FORM_"+isc.Comm.$jm++;_12+="Submitting to:<B>"+_2+"</B><BR>";_12+="<FORM ID="+_13+" METHOD="+(_8?_8:isc.Comm.sendMethod)+" ENCTYPE='application/x-www-form-urlencoded'"+" ACTION='"+_2+"'"+(_4!=window?" TARGET='"+_4+"'":"")+">";for(var _14 in _3){var _15=_3[_14];if(isc.isA.Function(_15))continue;_12+="<B>"+_14+" :</B><BR>\r&nbsp;&nbsp;"
...
,isc.A.hiddenFrameReply=function isc_c_Comm_hiddenFrameReply(_1,_2,_3){var _4=this.$jn[_1];delete this.$jn[_1];if(_4)this.fireCallback(_4,"transactionNum,results,wd",[_1,_2,_3])}
,isc.A.closeOperationPromptWindow=function isc_c_Comm_closeOperationPromptWindow(_1){if(!_1||_1.transport!="hiddenFrame")return;var _2=_1.$cv;if(_2==null)return;_1.$cv=null;if(isc.isA.HiddenFrame(_2)){_2.destroy();isc.HiddenFrame.$70j()}else{if(isc.isA.Function(_2.close))_2.close()}}
